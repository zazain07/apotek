            ...
            <form action="/pembayaran" method="post" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-4 w-[70vw]">
                    ...
                    <div class="flex justify-start items-start gap-2 text-white text-base">
                        ...
                        <p>Saya telah membaca dan memahami Syarat & Ketentuan Situs Apotek Senopati (yang dapat mengalami perubahan dari waktu ke waktu), dan dengan ini saya menyetujui untuk terikat pada ketentuan tersebut.</p>
                    </div>
                </div>
