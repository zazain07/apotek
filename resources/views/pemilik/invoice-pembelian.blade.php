    ...
    <section class="w-[45rem] print:w-full bg-white flex flex-col print:justify-between print:h-full">
        ...
        <main>
            <div class="py-8 tracking-wider flex flex-col gap-4">
                <p class="font-bold pl-20 text-xl">Apotek Senopati</p>
            ...
            <div class="w-full flex justify-center pt-4">
                <div class="flex flex-col w-[90%]">
                    ...
                    <p class="font-semibold text-mediumGrey">Transaksi yang sudah direspon oleh Apotek Senopati tidak dapat dibatalkan, kecuali dalam kondisi adanya pembatalan dari pihak Apotek Senopati</p>
                </div>
            </div>  
        </main>
        ...
        <footer class="w-full flex justify-center mt-16 print:mt-10">
            <div class="bg-black text-white flex justify-between w-[90%] px-16 py-8">
                <div class="flex flex-col justify-center w-3/5">
                    <p class="text-xl tracking-widest font-bold">Apotek Senopati</p>
                    <p class="text-md font-semibold">CP : 0819-3727-5129 (Reyvin)</p>
                </div>
                
                <div class="w-2/5">
                    <p>Ruko Jl. Senopati No.30 Blok F dan G, Kepuh, Betro, Kec. Sedati, Kabupaten Sidoarjo, Jawa Timur 61253</p>
                </div>
            </div>
        </footer>
